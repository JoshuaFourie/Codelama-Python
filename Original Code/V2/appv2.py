...
class MultiLanguageCodeBuddy:
    ...
    def setup_interface(self):
        ...
        with gr.Blocks(theme=custom_theme, css=custom_css, title=APP_NAME) as interface:
            ...
            with gr.Tabs():
                with gr.Tab("Chat", elem_classes="tab-content"):
                    with gr.Column(elem_classes="chat-container"):
                        # Enhanced Language selector with improved styling
                        ...
                        # Settings with accordion styling - Initially hidden, will be shown when settings button is clicked
            ...
            # Enhanced model unloading function that ensures memory is freed
            ...
            # Connect the enhanced unload function
            unload_btn.click(
            ...
            def respond(message, chat_history, lang_choice, temp, max_len):
                ...
                chat_response = "I've generated the requested code. You can see it in the code panel."
